...
import com.poja.cielux.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.poja.cielux.endpoint.event.gen.UuidCreated", payload);
